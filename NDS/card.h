...
#define CARD_CMD0      (*(vuint32*)0x040001A8)
#define CARD_CMD1      (*(vuint32*)0x040001AC)
...
#define CARD_ACTIVATE   0x80000000  // when writing, get the ball rolling
// 1<<30
...
// read bits
#define CARD_BUSY       0x80000000  // when reading, still expecting incomming data?
